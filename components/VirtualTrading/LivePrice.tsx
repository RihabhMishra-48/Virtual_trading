...
export default function LivePrice({ symbol, initialPrice }: LivePriceProps) {
    ...
    const priceColor = price > prevPrice ? 'text-green-500' : price < prevPrice ? 'text-red-500' : 'text-white';
    ...
    return (
        <div className="flex flex-col">
            <div className="flex items-baseline gap-3">
                ...
                <span className={`flex items-center gap-1 text-sm font-bold ${isPositive ? 'text-green-500' : 'text-red-500'} bg-white/5 px-2 py-0.5 rounded-full border border-white/5`}>
            ...
            <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-[10px] text-gray-500 font-medium uppercase tracking-widest">Live Market Data</span>
            </div>
        </div>
    );
}
